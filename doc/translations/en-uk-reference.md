# English ↔ Ukrainian translation reference

This document merges every key from `en.json` with the current `uk.json`. Each row lists the English source string alongside the Ukrainian translation. Empty Ukrainian values highlight strings still needing localisation. The table is sorted alphabetically by key so translators can quickly scan related phrases grouped together.

| Key | English | Ukrainian |
| --- | --- | --- |
| `ai_companion.actions.closePanel` | Close companion | Закрити супутника |
| `ai_companion.actions.formLabel` | Send a message | Надіслати повідомлення |
| `ai_companion.actions.hide` | Hide AI companion | Сховати AI-супутника |
| `ai_companion.actions.open` | Open AI companion | Відкрити AI-супутника |
| `ai_companion.actions.send` | Send | Надіслати |
| `ai_companion.actions.suggestionLabel` | Suggestions | Підказки |
| `ai_companion.dialogLabel` | AlgoRhythmics AI companion | AI-помічник AlgoRhythmics |
| `ai_companion.fallback` | I'm still learning, but I can connect you with the team or share highlights about our products, lab culture, and services. | Я ще вчуся, але можу зʼєднати вас з нашою командою або надіслати матеріали про продукти й послуги. |
| `ai_companion.greeting` | Hey there! I am Lumen, your AlgoRhythmics companion. Ask about our lab, products, or how we can partner on AI adventures. | Вітаю! Я Люмен — супутник AlgoRhythmics. Розкажу про нашу лабораторію, продукти та можливості партнерства з урахуванням українського ринку. |
| `ai_companion.knowledgeBase[0].answer` | AlgoRhythmics blends rigorous engineering with motion-inspired creativity. We operate as an innovation lab, shipping flagship products while mentoring partners so they inherit the same R&D mindset. | AlgoRhythmics поєднує інженерну дисципліну та креативність. Ми допомагаємо партнерам будувати сміливі AI-рішення й розвивати культуру інновацій на ринках Східної Європи. |
| `ai_companion.knowledgeBase[0].keywords[0]` | different | відрізняється |
| `ai_companion.knowledgeBase[0].keywords[1]` | unique | унікальність |
| `ai_companion.knowledgeBase[0].keywords[2]` | lab | лабораторія |
| `ai_companion.knowledgeBase[0].keywords[3]` | agency | агенція |
| `ai_companion.knowledgeBase[0].keywords[4]` | algorhythmics | algorhythmics |
| `ai_companion.knowledgeBase[0].keywords[5]` | culture |  |
| `ai_companion.knowledgeBase[1].answer` | NodeVoyage is our intelligent travel experience platform. It uses graph-powered itineraries, dynamic storytelling, and adaptive agents to craft journeys that feel both personal and delightfully unexpected. | NodeVoyage — це інтелектуальний супутник мандрівника. Він будує історії маршрутів, враховуючи локальні рекомендації, сезонність та ваш стиль відкриттів. |
| `ai_companion.knowledgeBase[1].keywords[0]` | nodevoyage | nodevoyage |
| `ai_companion.knowledgeBase[1].keywords[1]` | travel | подорож |
...
| `ai_companion.knowledgeBase[2].keywords[3]` | team | співпраця |
| `ai_companion.knowledgeBase[2].keywords[4]` | collaboration |  |
| `ai_companion.knowledgeBase[3].answer` | You can reach our consulting team through the contact page or by emailing hello@algorhythmics.com. We love scoping proofs of concept and long-term partnerships alike. | Напишіть на hello@algorhythmics.com або залиште заявку на сайті. Організуємо воркшоп чи discovery-спринт для старту спільної роботи. |
| `ai_companion.knowledgeBase[3].keywords[0]` | contact | контакт |
| `ai_companion.knowledgeBase[3].keywords[1]` | consulting | співпраця |
| `ai_companion.knowledgeBase[3].keywords[2]` | engage | консалтинг |
...
| `common.previous` | Previous | Попередній |
...
| `community.ideas_placeholder` | What feature would you love to see? | Яку функцію ви хочете бачити? |
...
| `consulting.hero_rotating[2]` | From prototype to production with our founders | Від прототипу до запуску разом із нашими засновниками |
...
| `contact.form_subject_placeholder` | Partnership opportunity | Партнерська можливість |
...
| `ideonautix.stat3_value` | AI-First | AI-First |
...
| `nodevoyage.hero_rotating[0]` | Nodi crafts adaptive itineraries in seconds | Nodi створює адаптивні маршрути за секунди |
...
| `products.hero_label` | Product studio | Продуктова студія |
...
| `timeline.milestones.education-program.description` | Begin rollout of AI education programs targeting Latvia's secondary schools | Запуск AI-програм для латвійських ліцеїв та гімназій |
