<script lang="ts">
            ...
            bullets: [
                {
                    ...
                    fallback:
                        "Facilitator checklists for travel crews and startup pods",
                },
                {
                    key: "help.page.knowledge.items.onboarding.bullets.1",
                    fallback:
                        "Orientation slides and talking points in EN · LV · RU",
                },
                {
                    key: "help.page.knowledge.items.onboarding.bullets.2",
                    fallback:
                        "Opt-in email templates and privacy notices ready to send",
                },
            ],
            accent: "aurora",
            cta: {
            ...
            bullets: [
                {
                    ...
                    fallback:
                        "Configure shared boards for family and classroom trips",
                },
                {
                    key: "help.page.knowledge.items.nodevoyage.bullets.1",
                    fallback:
                        "How memory anchors, AR translation, and offline mode work",
                },
                {
                    key: "help.page.knowledge.items.nodevoyage.bullets.2",
                    fallback:
                        "Service levels & response windows for premium pilots",
                },
            ],
            accent: "voyage",
            cta: {
            ...
            bullets: [
                {
                    ...
                    fallback:
                        "Pitch Assistant script library with rehearsal notes",
                },
                {
                    key: "help.page.knowledge.items.ideonautix.bullets.1",
                    fallback:
                        "Pomodoro Coach and focus rituals for hybrid teams",
                },
                {
                    key: "help.page.knowledge.items.ideonautix.bullets.2",
                    fallback:
                        "Security briefings and API scopes for technical leads",
                },
            ],
            accent: "ideonautix",
            cta: {
            ...
            bullets: [
                {
                    ...
                    fallback:
                        "GDPR-ready privacy templates and data processing notes",
                },
                {
                    key: "help.page.knowledge.items.policies.bullets.1",
                    fallback:
                        "AAA accessibility commitments and reporting loop",
                },
                {
                    key: "help.page.knowledge.items.policies.bullets.2",
                    fallback:
                        "Status communication workflow for outages and incidents",
                },
            ],
            accent: "neutral",
            cta: {
    ...
    const faqs = [
        ...
        },
        {
            ...
            questionFallback:
                "Where can I find training for my classroom or team?",
        ...
        },
        {
            ...
            questionFallback:
                "Do you offer SLA-backed support for enterprises?",
    ...
    const escalation = {
        ...
        channels: [
            ...
            },
            {
                ...
                copyFallback:
                    "Pilot and consulting partners get a dedicated Signal channel with 24-hour coverage.",
            ...
            },
            {
                ...
                copyFallback:
                    "Join our calm AI clinics for live demos, Q&A, and peer learning stories.",
        ...
        items: [
            {
                ...
                titleFallback:
                    "Calm AI onboarding playbook — April 2026 update",
            ...
            },
            {
                ...
                titleFallback:
                    "Ideonautix Pomodoro Coach — troubleshooting checklist",
...
>
    <svelte:fragment slot="status">
        <span class="hero-kicker surface-pill" data-tone="accent"
            >{t(hero.eyebrowKey, hero.eyebrowFallback)}</span
        >
    </svelte:fragment>
    <svelte:fragment slot="description">
        <p class="hero-description">
            {t(hero.descriptionKey, hero.descriptionFallback)}
        </p>
    </svelte:fragment>
...
<section class="section knowledge" data-surface="glow" use:revealOnScroll>
    <div class="container">
        ...
        <div class="knowledge-grid" use:staggerReveal>
            <GlassCard
                class="knowledge-card knowledge-card--media"
                padding="lg"
                particles
            >
                <figure class="media-card">
                    <img
                        ...
                        alt={t(
                            knowledgeMedia.altKey,
                            knowledgeMedia.altFallback,
                        )}
                        loading="lazy"
                        width="640"
                        height="400"
                    ...
                    <figcaption class="media-card__caption">
                        {t(
                            knowledgeMedia.captionKey,
                            knowledgeMedia.captionFallback,
                        )}
                    </figcaption>
                </figure>
            </GlassCard>
            ...
            {#each knowledgeBase as category (category.titleKey)}
                ...
                >
                    ...
                    <Button
                        ...
                        size="md"
                        >{t(
                            category.cta.labelKey,
                            category.cta.labelFallback,
                        )}</Button
                    >
                </GlassCard>
            {/each}
            ...
            {#each statusUpdates as update (update.statusKey)}
                ...
                >
                    <div class="status-pill">
                        {t(update.statusKey, update.statusFallback)}
                    </div>
                    <p class="status-meta">
                        {t(update.metaKey, update.metaFallback)}
                    </p>
                    <p>
                        {t(update.descriptionKey, update.descriptionFallback)}
                    </p>
                </GlassCard>
            {/each}
        </div>
    ...
    <div class="container">
        <div class="escalation-grid" use:staggerReveal>
            <GlassCard
                ...
                halo
                interactive
                data-tone="escalation"
            >
                <span class="section-eyebrow"
                    >{t(
                        escalation.eyebrowKey,
                        escalation.eyebrowFallback,
                    )}</span
                >
                    ...
                    {#each escalation.channels as channel (channel.titleKey)}
                        <div class="channel">
                            ...
                            <div class="channel-copy">
                                <h3>
                                    {t(channel.titleKey, channel.titleFallback)}
                                </h3>
                                <p>
            ...
            >
                <span class="section-eyebrow"
                    >{t(
                        resourceArchive.eyebrowKey,
                        resourceArchive.eyebrowFallback,
                    )}</span
                >
                <h2>
                    {t(resourceArchive.titleKey, resourceArchive.titleFallback)}
                </h2>
                <p>
                    {t(resourceArchive.copyKey, resourceArchive.copyFallback)}
                </p>
                        ...
                        <li>
                            <div class="resource-meta">
                                <span class="resource-title"
                                    >{t(
                                        resource.titleKey,
                                        resource.titleFallback,
                                    )}</span
                                >
                                <span class="resource-tag"
                                    >{t(
                                        resource.metaKey,
                                        resource.metaFallback,
                                    )}</span
                                >
                            </div>
                            <p>
...
<style>
    ...
    :global(.knowledge-card[data-tone="aurora"]) {
        --glass-card-surface: color-mix(
            in srgb,
            var(--bg-elev-1) 92%,
            rgba(var(--aurora-purple-rgb), 0.12) 8%
        );
        --glass-card-border: color-mix(
            in srgb,
            rgba(var(--aurora-purple-rgb), 0.42) 50%,
            transparent 50%
        );
        ...
        --glass-card-veil: color-mix(
            in srgb,
            rgba(var(--aurora-purple-rgb), 0.24) 38%,
            transparent 62%
        );
    ...
    :global(.knowledge-card[data-tone="voyage"]) {
        ...
        --glass-card-border: color-mix(
            in srgb,
            rgba(var(--voyage-blue-rgb), 0.38) 52%,
            transparent 48%
        );
        ...
        --glass-card-veil: color-mix(
            in srgb,
            rgba(var(--voyage-blue-rgb), 0.24) 40%,
            transparent 60%
        );
    ...
    :global(.knowledge-card[data-tone="ideonautix"]) {
        --glass-card-surface: color-mix(
            in srgb,
            var(--bg-elev-1) 88%,
            rgba(var(--slate-base-rgb), 0.2) 12%
        );
        --glass-card-border: color-mix(
            in srgb,
            rgba(var(--slate-base-rgb), 0.45) 52%,
            transparent 48%
        );
        ...
        --glass-card-veil: color-mix(
            in srgb,
            rgba(var(--slate-base-rgb), 0.28) 40%,
            transparent 60%
        );
    ...
    :global(.knowledge-card[data-tone="neutral"]) {
        --glass-card-surface: color-mix(
            in srgb,
            var(--bg-elev-1) 94%,
            rgba(var(--ink-rgb), 0.08) 6%
        );
        --glass-card-border: color-mix(
            in srgb,
            rgba(var(--ink-rgb), 0.18) 56%,
            transparent 44%
        );
    ...
    :global(.faq-card) {
        ...
        --glass-card-border: color-mix(
            in srgb,
            rgba(var(--voyage-blue-rgb), 0.32) 50%,
            transparent 50%
        );
    ...
    :global(.status-card) {
        ...
        --glass-card-border: color-mix(
            in srgb,
            rgba(var(--aurora-purple-rgb), 0.26) 48%,
            transparent 52%
        );
        --glass-card-spot-a: rgba(var(--aurora-purple-rgb), 0.28);
        --glass-card-spot-b: rgba(var(--voyage-blue-rgb), 0.2);
    ...
    :global(.escalation-card[data-tone="escalation"]) {
        ...
        --glass-card-border: color-mix(
            in srgb,
            rgba(var(--signal-yellow-rgb), 0.22) 52%,
            transparent 48%
        );
    ...
    :global(.resources-card[data-tone="resources"]) {
        ...
        --glass-card-border: color-mix(
            in srgb,
            rgba(var(--aurora-purple-rgb), 0.2) 54%,
            transparent 46%
        );
        ...
        --glass-card-veil: color-mix(
            in srgb,
            rgba(var(--aurora-purple-rgb), 0.24) 36%,
            transparent 64%
        );
        --glass-card-halo: rgba(var(--aurora-purple-rgb), 0.26);
    }
