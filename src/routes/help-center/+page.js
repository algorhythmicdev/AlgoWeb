export const load = () => ({
  meta: {
    title: 'Help Center | AlgoRhythmics Support Hub',
    description:
      'Browse calm AI guides, knowledge base articles, and status updates for NodeVoyage, Ideonautix, and consulting programmes.',
