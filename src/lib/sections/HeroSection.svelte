...
<section class="hero section" id="hero" use:revealOnScroll>
...
<style>
  .hero {
    ...
    background:
      radial-gradient(120% 140% at 0% 0%, rgba(19, 81, 255, 0.12) 0%, transparent 65%),
      radial-gradient(120% 120% at 100% 20%, rgba(106, 56, 255, 0.1) 0%, transparent 70%);
  }
